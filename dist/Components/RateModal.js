...
class RateModal extends react_1.Component {
	...
	renderRatingView() {
		...
		return react_1.default.createElement(
			...
			react_1.default.createElement(react_native_ratings_1.AirbnbRating, {
				...
				reviews: starLabels,
				onFinishRating: e => this.onStarSelected(e)
			}),
			react_1.default.createElement(
				react_native_1.View,
	...
	renderContactFormView() {
		...
		return react_1.default.createElement(
			react_1.default.Fragment,
			null,
			react_1.default.createElement(TextBox_1.TextBox, {
				containerStyle: [RateModal_1.RateModalStyles.textBox],
